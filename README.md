...
- [Примеры рендеров](#примеры-рендеров)
- [Пример использования функционала](#пример-использования-функционала)
- [Сборка](#сборка)
- [Структура репозитория](#структура-репозитория)
- [Основные возможности](#основные-возможности)
  - [Математическое ядро](#математическое-ядро)
  - [Работа с изображениями (BMP)](#работа-с-изображениями-bmp)
  - [Фрактальный рендерер](#фрактальный-рендерер)
  - [Анимация фракталов](#анимация-фракталов)
  - [Обобщённый рендеринг через Concepts](#обобщённый-рендеринг-через-concepts)
