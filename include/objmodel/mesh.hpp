...
namespace iheay::objmodel {
    ...
    public:
        ...
        [[nodiscard]] const std::vector<iheay::math::Vec3>& get_vertices() const { return m_vertices; }
        [[nodiscard]] const std::vector<std::vector<int>>& get_indexes() const { return m_indexes; }
