...
Bmp fractal::draw_mandelbrot2(int width, int height) {
    bmp::Bmp img = bmp::Bmp::empty(width, height);
    ...
    fractal::render_complex_fractal2(
        img, view,
        [](auto& z, auto& c) { return z*z + c; },
        [](auto&) { return Complex::Zero(); },
        [](auto& pixel) { return pixel; },
...
Bmp fractal::draw_julia2(int width, int height) {
    bmp::Bmp img = bmp::Bmp::empty(width, height);
...
Bmp fractal::draw_burning_ship2(int width, int height) {
    bmp::Bmp img = bmp::Bmp::empty(width, height);
